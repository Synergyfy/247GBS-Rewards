    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative"
        >
          <div className="relative bg-blue-600 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-blue-600/30">
            <div className="relative z-10 p-8 md:p-16 lg:p-20 text-center">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl text-blue-50 mb-10 leading-relaxed max-w-2xl mx-auto font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  <Link href="/signup">
                    <button className="group relative w-full sm:w-auto px-10 py-5 rounded-full font-black text-xl bg-white text-blue-600 shadow-xl hover:shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-2">
                      Join 247GBS Now
                      <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
                    </button>
                  </Link>
                  <Link href="#calculator">
                    <button className="w-full sm:w-auto px-10 py-5 rounded-full font-bold text-xl bg-blue-700 text-white border border-blue-500 hover:bg-blue-800 transition-all flex items-center justify-center gap-2">
