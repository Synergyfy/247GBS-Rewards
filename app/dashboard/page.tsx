...
const Settings = dynamic(() => import('./Content/ProfileManagement/Settings'), {
  ssr: false,
});
const QRScanner = dynamic(() => import('./Content/Dashboard/QRCodeScanner'), {
  ssr: false,
});
const CustomersTab = dynamic(() => import('./Content/Dashboard/CustomersTab'), {
  ssr: false,
});
const AdminOnlyFeature = dynamic(
  () => import('./Content/Dashboard/AdminOnlyFeature'),
  { ssr: false }
);
const Earning = dynamic(() => import('./Content/Analytics/Earning'), {
  ssr: false,
});
const QRCodeScanHistory = dynamic(
  () => import('./Content/Analytics/QRCodeScanHistory'),
  { ssr: false }
);
const Spending = dynamic(() => import('./Content/Analytics/Spending'), {
  ssr: false,
});
const YourProfile = dynamic(
  () => import('./Content/ProfileManagement/YourProfile'),
  { ssr: false }
);
const Businesses = dynamic(
  () => import('./Content/ProfileManagement/Businesses'),
  { ssr: false }
);
const Staff = dynamic(() => import('./Content/ProfileManagement/Staff'), {
  ssr: false,
});
const NationalMembership = dynamic(
  () => import('./Content/ProfileManagement/NationalMembership'),
  { ssr: false }
);
const Consumers = dynamic(
  () => import('./Content/ProfileManagement/Consumers'),
  { ssr: false }
);
const AccountManagers = dynamic(
  () => import('./Content/ProfileManagement/AccountManagers'),
  { ssr: false }
);
const Agents = dynamic(() => import('./Content/ProfileManagement/Agents'), {
  ssr: false,
});
const Consultants = dynamic(
  () => import('./Content/ProfileManagement/Consultants'),
  { ssr: false }
);
const Segment = dynamic(() => import('./Content/ProfileManagement/Segment'), {
  ssr: false,
});
...
const McomPoints = dynamic(
  () => import('./Content/MCOMAccessandSettings/McomPoints'),
  { ssr: false }
);
const McomCredits = dynamic(
  () => import('./Content/MCOMAccessandSettings/McomCredits'),
  { ssr: false }
);
const McomStamps = dynamic(
  () => import('./Content/MCOMAccessandSettings/McomStamps'),
  { ssr: false }
);
const McomTokens = dynamic(
  () => import('./Content/MCOMAccessandSettings/McomTokens'),
  { ssr: false }
);
const McomWhiteLabelPardner = dynamic(
  () => import('./Content/MCOMAccessandSettings/McomTokens'),
  { ssr: false }
);
const McomExchangeAndRedeem = dynamic(
  () => import('./Content/MCOMAccessandSettings/McomTokens'),
  { ssr: false }
);
